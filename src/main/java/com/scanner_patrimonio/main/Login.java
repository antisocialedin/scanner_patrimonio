package com.scanner_patrimonio.main;
...
import com.scanner_patrimonio.view.menu.Menu;
...
public class Login extends JFrame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 7088612406006668308L;
	...
	private void initComponents() {
		...
		lblNewLabel = new JLabel("Prontuario");
			...
			gl_panel.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_panel.createSequentialGroup()
					...
					.addGroup(gl_panel.createParallelGroup(Alignment.LEADING, false)
						...
						.addComponent(textFieldProntuario, GroupLayout.DEFAULT_SIZE, 422, Short.MAX_VALUE))
