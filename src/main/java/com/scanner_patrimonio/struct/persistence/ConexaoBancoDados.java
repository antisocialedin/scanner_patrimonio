package com.scanner_patrimonio.struct.persistence;
...
public class ConexaoBancoDados {
	...
	private EntityManagerFactory getCriarFabricaConexao() {
		...
		properties.put("hibernate.connection.url", "jdbc:mysql://localhost:3306/scanner_patrimonio?createDatabaseIfNotExist=true&useSSL=false");
